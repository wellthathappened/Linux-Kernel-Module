...
#define DEVICE_NAME "ReadDevice"
#define BUFFER_SIZE 1024
#define EBUSY 16

MODULE_LICENSE("GPL");            
MODULE_AUTHOR("SA, IL, JK");  
MODULE_DESCRIPTION("Linux char driver to read PA3"); 
MODULE_VERSION("2"); 
...
ssize_t readFromDevice(struct file *, char *, size_t, loff_t *);
...
ssize_t readFromDevice(struct file *filp, char *buffer, size_t length, loff_t *offset)
{
